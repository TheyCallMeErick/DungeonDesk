...
public class OnlyTheDeskMasterShoudManageDesk : IValidationRule<OnlyTheDeskMasterShoudManageDeskDTO>
{
    public ValidationResult Validate(OnlyTheDeskMasterShoudManageDeskDTO dto)
    {
